...
class _SplashViewState extends State<SplashView> {
  ...
  Future<void> _initialize() async {
    // Run real initialization work; native splash stays until this resolves.
    await Future.wait([
      Future.delayed(const Duration(milliseconds: 1500)), // minimum brand moment
      _prefetchAppState(),
    ]);
  ...
  Future<void> _prefetchAppState() async {
    ...
    // Add async initialization calls here as the app grows.
  }
